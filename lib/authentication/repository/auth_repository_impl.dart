...
class AuthRepositoryImpl extends AuthRepositoryAbstract {
  ...
  @override
  Future<Map<String, dynamic>> userVerification(String inputCode,String newPassword,  String token) async{
  ...
  Future<Map<String, dynamic>> requestTokenAgain(String token) async{
    ...
    Map<String,dynamic> response = await HttpHandlerImpl.instance.post(url: LoginRoutes.requesttoken, body: body,token: token);
    return response;
  }
