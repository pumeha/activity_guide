...
class TemplateRepoImpl extends TemplateRepoAbstr {
  ...
  @override
  Future<Map<String, dynamic>> updateTemplate({required String name, required String values, required String token}) async{
    dynamic data = {'template_name':name,'values':values};
    dynamic body = jsonEncode(data);
  ...
  @override
  Future<Map<String, dynamic>> deleteTemplate({required String name, required String token}) async{
    dynamic data = {'template_name':name};
    dynamic body = jsonEncode(data);

    Map<String,dynamic> response = await HttpHandlerImpl.instance.delete(url: TemplateRoutes.deleteTemplate,
