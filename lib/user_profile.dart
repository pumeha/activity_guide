      ...
      builder: (context,snapshot){
       ...
       return ListView(
            children:  [
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: ListTile(title: CustomText(text: snapshot.data![0] == 'user' ? 'Staff Dept/Unit': 'Role'),
                subtitle: Padding(
                  padding: const EdgeInsets.all(8),
                  child: CustomText(text: snapshot.data![0] == 'user' ? snapshot.data![2].toUpperCase() : snapshot.data![0].toUpperCase(),
